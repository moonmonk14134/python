CREATE TABLE target01_stat_data (
...
alter table target01_stat_data add primary key (Td_date,symbol) ;
alter table target01_stat_data add column memo varchar(255) ;
alter table target01_stat_data add column ded20 decimal(10,2) DEFAULT NULL;
alter table target01_stat_data add column ded60 decimal(10,2) DEFAULT NULL;
alter table target01_stat_data add column ded120 decimal(10,2) DEFAULT NULL;
